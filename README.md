...
1. Navigate to http://localhost:3000.
   ...
   ![Zoom React Meeting SDK](https://marketplace.zoom.us/docs/images/migrated/1607987466824.png)

1. Click "Join Meeting" to join the meeting number specified in `src/app.js`.

   ![Zoom React Meeting SDK](https://marketplace.zoom.us/docs/images/migrated/1607987479967.png)
